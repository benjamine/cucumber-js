function AstTreeWalker(features, supportCodeLibrary, listeners, options) {
  ...
  var self = {
    ...
    visitBeforeSteps: function visitBeforeSteps(callback) {
      Cucumber.Util.asyncForEach(beforeSteps, function (beforeStep, callback) {
        self.witnessHook();
    ...
    visitAfterSteps: function visitAfterSteps(callback) {
      Cucumber.Util.asyncForEach(afterSteps, function (afterStep, callback) {
        self.witnessHook();
